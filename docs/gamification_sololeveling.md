...
Non-goals for v1: full action combat, huge 3D assets, or blocking the core Pomodoro/workout UX behind downloads.


These are highly opinionated. and can switch back to the regular use - mode anytime.  
