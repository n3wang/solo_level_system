...
/// Case 1 is data only. Future cases can define different rows and questions
...
const case1Definition = CaseMathCaseDefinition(
  ...
  questions: [
    CaseMathQuestionDefinition(
      ...
      variables: {
        'revenue': CaseMathVariableBinding.value('revenue'),
        'costs': CaseMathVariableBinding.value('operatingCosts'),
      },
    ),
    CaseMathQuestionDefinition(
      id: 'profit_margin',
    ...
    CaseMathQuestionDefinition(
      ...
      variables: {
        'revenue': CaseMathVariableBinding.value('revenue'),
        'oldRevenue':
            CaseMathVariableBinding.value('revenue', yearOffset: -1),
      },
    ),
    CaseMathQuestionDefinition(
      id: 'profit_growth',
      ...
      variables: {
        ...
        'oldRevenue':
            CaseMathVariableBinding.value('revenue', yearOffset: -1),
        'oldCosts':
            CaseMathVariableBinding.value('operatingCosts', yearOffset: -1),
      },
    ),
    CaseMathQuestionDefinition(
      ...
      variables: {
        'revenue': CaseMathVariableBinding.value('revenue'),
        'stores': CaseMathVariableBinding.value('stores'),
        'oldRevenue':
            CaseMathVariableBinding.value('revenue', yearOffset: -1),
        'oldStores':
            CaseMathVariableBinding.value('stores', yearOffset: -1),
      },
    ),
    CaseMathQuestionDefinition(
      ...
      variables: {
        'revenue': CaseMathVariableBinding.value('revenue'),
        'customers': CaseMathVariableBinding.value('customers'),
      },
    ),
    CaseMathQuestionDefinition(
      id: 'max_costs',
